...
struct Paciente desencolar(struct Cola & cola){
    ...
    struct Paciente elemento = retornaCabeza(cola.lista);
...
void encolarConPrioridad(struct Cola &cola, struct Paciente paciente){
    insertarConPrioridad(cola.lista, paciente);
}