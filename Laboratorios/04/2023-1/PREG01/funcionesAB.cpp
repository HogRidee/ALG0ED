...
struct NodoArbol * crearNuevoNodo(struct NodoArbol * izquierda, struct Servidor elemento,
...
void plantarArbolBinario(struct ArbolBinario & arbol, struct NodoArbol * izquierda, 
                         struct Servidor elemento, struct NodoArbol * derecha) {
...
void plantarArbolBinario(struct NodoArbol *& raiz, 
                    struct NodoArbol * izquierda, struct Servidor elemento, 
                    struct NodoArbol * derecha){
...
void plantarArbolBinario(struct ArbolBinario & arbol, struct ArbolBinario & arbolIzquierda, 
                         struct Servidor elemento, struct ArbolBinario & arbolDerecha) {
...
void imprimirNodo(struct NodoArbol * raiz){
    cout<<setw(5)<<raiz->elemento.velocidad;
}
