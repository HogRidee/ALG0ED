...
void insertarAlInicio(struct Lista & lista, struct Llegada elemento) {
...
void insertarAlFinal(struct Lista & lista, struct Llegada elemento) {
...
struct Nodo * crearNodo(struct Llegada elemento, struct Nodo * siguiente) {
    struct Nodo * nuevoNodo = new struct Nodo;
    nuevoNodo->elemento = elemento;
...
//void insertarEnOrden(struct Lista & lista, struct Llegada elemento) {
//
...
//struct Nodo * obtenerNodoAnterior(const struct Lista & lista, struct Llegada elemento) {
...
//struct Nodo * seEncuentra(const struct Lista & lista, struct Llegada elemento) {
//    struct Nodo * recorrido = lista.cabeza;
//
...
void eliminaNodo(struct Lista & lista, struct Llegada elemento) {
    struct Nodo * ultimo = nullptr;
    struct Nodo * recorrido = lista.cabeza;
    /*Avanzo hasta encontrar el elemento*/
    /*Si no lo encuentra no elimina nada*/
    while ((recorrido != nullptr) and (recorrido->elemento.avion != elemento.avion)) {
        ultimo = recorrido;
        recorrido = recorrido->siguiente;
    }
...
void imprime(const struct Lista & lista) {
    ...
    if (esListaVacia(lista)) {
        ...
        while (recorrido != nullptr) {
            ...
            cout << recorrido->elemento.avion << " ";
            cout << recorrido->elemento.horasLlegada << ":" 
                    << recorrido->elemento.minutosLlegada << " ";
            cout << recorrido->elemento.horasNuevo << ":" 
                    << recorrido->elemento.minutosNuevo;
            recorrido = recorrido->siguiente;
        }
        cout << "]" << endl;
    }
